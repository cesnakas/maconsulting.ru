                    ...
                    <ul class="nav-page__ul nav-page__ul--two">
                        <li class="nav-page__li">
                            <a href="#page1" class="nav-page__link link-anchor">
                                ...
                                <span class="nav-page__name">Образовательные программы и тренинги для сотрудников фармацевтических компаний</span>
                            </a>
                        </li>
                        <li class="nav-page__li">
                            <a href="#page2" class="nav-page__link link-anchor">
                                <span class="nav-page__count">02</span>
                                <span class="nav-page__name">Семинары для организаторов здравоохранения и врачей</span>
                            </a>
                        </li>
                    </ul>
                    */?>
