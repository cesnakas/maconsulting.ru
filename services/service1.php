            ...
            <div class="heading-page__img-wrap _anim-items _anim-no-hide">
                <div class="heading-page__paralax">
                    <div class="heading-page__paralaxWrap">
                        <img src="<?=SITE_TEMPLATE_PATH?>/dist/img/services/1.png" alt=""/>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="container">
            <div class="spoilersWrap animUp _anim-items _anim-no-hide">
                <div class="spoilersItem">
                    <button class="spoilersItem__btn active">Нормативно правовая экспертиза<span class="spoilersItem__icon"></span></button>
                    <div class="spoilersItem__content" style="display: block;">
                        <div class="spoilersItem__flex">
                            <div class="spoilersItem__text">
                                <p>Анализ системы нормативно-правового регулирования, которая влияет на систему оказания медицинской помощи и финансирование технологий, а также законопроектов на стадии разработки и иных НПА. А также подготовка аналитической справки по возможным изменениям и тенденциям в нормативно-правовом поле,  влияющим на бизнес компании.</p>
                            </div>
                        </div>
                    </div>
                </div>
                <div class="spoilersItem">
                    <button class="spoilersItem__btn">Сбор официальной статистики по заболеваниям
                        субъектов РФ<span class="spoilersItem__icon"></span></button>
                ...
                <div class="spoilersItem">
                    <button class="spoilersItem__btn">Путь пациента Patient Journey<span class="spoilersItem__icon"></span></button>
                    <div class="spoilersItem__content">
                        <div class="spoilersItem__flex">
                            <div class="spoilersItem__text">
                                <p>Анализ системы нормативно-правового регулирования, которая влияет на систему оказания медицинской помощи и финансирование технологий, а также законопроектов на стадии разработки и иных НПА. А также подготовка аналитической справки по возможным изменениям и тенденциям в нормативно-правовом поле,  влияющим на бизнес компании.</p>
                ...
                <div class="spoilersItem">
                    <button class="spoilersItem__btn">Исследование приоритетов и ожиданий ЛПР<span class="spoilersItem__icon"></span></button>
                    <div class="spoilersItem__content">
                        <div class="spoilersItem__flex">
                            <div class="spoilersItem__text">
                                <p>Анализ системы нормативно-правового регулирования, которая влияет на систему оказания медицинской помощи и финансирование технологий, а также законопроектов на стадии разработки и иных НПА. А также подготовка аналитической справки по возможным изменениям и тенденциям в нормативно-правовом поле,  влияющим на бизнес компании.</p>
                ...
                <div class="spoilersItem">
                    <button class="spoilersItem__btn">Экспертно-формирующий опрос<span class="spoilersItem__icon"></span></button>
                    <div class="spoilersItem__content">
                        <div class="spoilersItem__flex">
                            <div class="spoilersItem__text">
                                <p>Анализ системы нормативно-правового регулирования, которая влияет на систему оказания медицинской помощи и финансирование технологий, а также законопроектов на стадии разработки и иных НПА. А также подготовка аналитической справки по возможным изменениям и тенденциям в нормативно-правовом поле,  влияющим на бизнес компании.</p>
            ...
            <a href="<?=SITE_DIR?>contacts/" class="more-link animUp _anim-items _anim-no-hide">Связаться с нашим<br>специалистом</a>
