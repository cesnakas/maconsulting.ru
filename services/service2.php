        ...
        <div class="container">
            <div class="spoilersWrap animUp _anim-items _anim-no-hide">
                <div class="spoilersItem">
                    <button class="spoilersItem__btn active">Фармакоэкономические исследования<span class="spoilersItem__icon"></span></button>
                    <div class="spoilersItem__content" style="display: block;">
                        <div class="spoilersItem__flex">
                            <div class="spoilersItem__text">
                                <p>Проведение анализа затратной эффективности, анализа стоимости заболевания, анализа влияния на бюджет позволит разработать и собрать данные о преимуществах предлагаемого продукта, оценить его влияние на клинический, экономический и социальный исходы, проанализировать социальную значимость заболевания.</p>
                            </div>
                        </div>
                    </div>
                </div>
                <div class="spoilersItem">
                    <button class="spoilersItem__btn">Фармакоэкономические модели<span class="spoilersItem__icon"></span></button>
                ...
                <div class="spoilersItem">
                    <button class="spoilersItem__btn">Консультирование и помощь в создании досье
                        на лекарственные препараты или медицинские изделия<span class="spoilersItem__icon"></span></button>
                    <div class="spoilersItem__content">
                        <div class="spoilersItem__flex">
                            <div class="spoilersItem__text">
                                <p>Проведение анализа затратной эффективности, анализа стоимости заболевания, анализа влияния на бюджет позволит разработать и собрать данные о преимуществах предлагаемого продукта, оценить его влияние на клинический, экономический и социальный исходы, проанализировать социальную значимость заболевания.</p>
                ...
                <div class="spoilersItem">
                    <button class="spoilersItem__btn">Создание ценностного предложения
                        для продукта<span class="spoilersItem__icon"></span></button>
                    <div class="spoilersItem__content">
                        <div class="spoilersItem__flex">
                            <div class="spoilersItem__text">
                                <p>Проведение анализа затратной эффективности, анализа стоимости заболевания, анализа влияния на бюджет позволит разработать и собрать данные о преимуществах предлагаемого продукта, оценить его влияние на клинический, экономический и социальный исходы, проанализировать социальную значимость заболевания.</p>
