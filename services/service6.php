...
?>
            ...
            <div class="heading-page__content">
                ...
                <div class="service-pagination">
                    ...
                    <div class="service-pagination__btn">
                        <a href="service5.html" class="service-pagination__btn-prev nav__link-anim"></a>
                        <a href="service7.html" class="service-pagination__btn-next nav__link-anim"></a>
                    </div>
                </div>
    ...
    <div class="paralax">
        <div class="paralaxImgWrap">
            <img class="paralaxImg" src="img/bg/22.png" alt=""/>
        </div>
    </div>
